...
$routes->get('/kabupaten/cari', 'Kabupaten::cari');
$routes->get('/kabupaten/filter/{id}', 'Kabupaten::filter');
$routes->get('/rekap', 'Kabupaten::rekap');

$routes->get('/provinsi', 'Provinsi::index');
$routes->post('/provinsi/tambah', 'Provinsi::tambah');
$routes->get('/provinsi/cari', 'Provinsi::cari');
