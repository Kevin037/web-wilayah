...
<div class="row">
  ...
  <div class="col-md-4">
  <form action="/kabupaten/cari" method="POST" class="d-flex">
  ...
  <div class="" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                      ...
                      <?php foreach($p as $pp) : ?>
                        <li><a class="dropdown-item" href="/kabupaten/filter/<?php echo $pp["id"]?>"><?php echo $pp["nama_provinsi"]?></a></li>
                        <?php endforeach;  ?>
                      </ul>
                    </li> 
                    </ul>
...
<table class="table">
  ...
  <?php foreach($k as $kk) : ?>
    <tr>
      ...
      <td><?php echo $kk["jumlah_penduduk"]?></td>
    </tr>
    <?php
    $no++;
    endforeach;  ?>
